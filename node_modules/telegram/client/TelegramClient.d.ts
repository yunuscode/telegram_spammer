...
export declare class TelegramClient extends TelegramBaseClient {
     ...
     * ```
     */
    downloadProfilePhoto(entity: EntityLike, downloadProfilePhotoParams?: downloadMethods.DownloadProfilePhotoParams): Promise<Buffer>;
    /**
     ...
     * ```
     */
    downloadMedia(messageOrMedia: Api.Message | Api.TypeMessageMedia, downloadParams: DownloadMediaInterface): Promise<Buffer>;
    /**
